...
def input_Nodes_Uses(
    ...
    try:
        ...
        for s in sq:
            ...
            #You cant need non-node properties to create Nodes
            node_columns = [i for i in column_names if i not in ["Key", "DatasetID"]] + ["importID"]
            nodes = pd.DataFrame()
    ...
    if uploadOption == "add_node":
        ...
        print(dataset_for_results.info())
