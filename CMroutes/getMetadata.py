...
def getDomains(database):
    ...
    domains = getQuery("MATCH (n:LABEL) where n.public = 'TRUE' and not n.CMName = 'CATEGORY' and n.groupLabel=n.CMName RETURN  n.groupLabel AS domain order by n.displayOrder,domain", driver, type="list")
...
def getDomainDescriptions(database):
    ...
    descriptions = getQuery("MATCH (n:LABEL) where n.CMName = n.groupLabel and n.public = 'TRUE' and not n.CMName = 'CATEGORY' RETURN DISTINCT n.CMName AS label, n.description AS description order by label", driver, type="dict")
